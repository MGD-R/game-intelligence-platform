...
8. Bayesian rating: почему naive source ratings нужно корректировать числом голосов.
9. Next research directions: embeddings, calibration improvement, IGDB-specific matching,
