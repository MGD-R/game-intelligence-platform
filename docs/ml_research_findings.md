...
8. Active learning: как модель предлагает следующие пары для разметки.
9. Recommendations: explainable content baseline и его ограничения.
10. Bayesian rating: почему naive source ratings нужно корректировать числом голосов.
11. Next research directions: neural embeddings, calibration improvement, IGDB-specific matching,
