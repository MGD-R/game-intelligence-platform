...
7. Active learning: как модель предлагает следующие пары для разметки.
8. Recommendations: explainable content baseline и его ограничения.
9. Bayesian rating: почему naive source ratings нужно корректировать числом голосов.
10. Next research directions: embeddings, calibration improvement, IGDB-specific matching,
